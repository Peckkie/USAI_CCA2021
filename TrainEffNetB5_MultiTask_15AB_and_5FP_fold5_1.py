...
dataframe_train = pd.read_csv (r'/home/yupaporn/codes/USAI/Traindf_fold5.csv')
dataframe_test = pd.read_csv (r'/home/yupaporn/codes/USAI/Validationdf_fold5.csv')
train_dir = '/media/tohn/SSD/Images/Image5/train/'
test_dir = '/media/tohn/SSD/Images/Image5/validation/'
...
train_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_5/mylogsnow_15AB_5FP_1FC_1/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_5/mylogsnow_15AB_5FP_1FC_1/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImages/R2_5/models/MultiTask_EffNetB5_15AB_5FP_fold5_1.h5')
