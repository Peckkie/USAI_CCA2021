...
dataframe_train = pd.read_csv (r'/home/yupaporn/codes/USAI/Traindf_fold6.csv')
dataframe_test = pd.read_csv (r'/home/yupaporn/codes/USAI/Validationdf_fold6.csv')
train_dir = '/media/tohn/SSD/Images/Image6/train/'
test_dir = '/media/tohn/SSD/Images/Image6/validation/'
...
EPOCHS = 100
batch_size = 16
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_6/models/B5_R1_15AB_relu_1FC_fold6_1.h5'
...
train_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_6/mylogsnow_15AB_5FP_1FC_1/' + current_time + '/train'
test_log_dir = '/media/tohn/SSD/ModelTrainByImages/R2_6/mylogsnow_15AB_5FP_1FC_1/' + current_time + '/test'
...
#save model   
model2.save('/media/tohn/SSD/ModelTrainByImages/R2_6/models/MultiTask_EffNetB5_15AB_5FP_fold6_1.h5')
