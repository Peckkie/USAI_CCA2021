...
#validation
valframe = pd.read_csv( '/home/yupaporn/CSV_file/Test_Dataset_CCA_1328.csv')
...
prediction_layer = layers.Dense(20, activation='softmax',name = 'prediction_layer')(dropout_layer_1)
...
os.chdir('/media/tohn/SSD/ModelTrainByImages/R1_Full')

# root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_Full/mylogsB5_15AB_Full_set1_AddNewDataset'
# def get_run_logdir():
#     import time
...
model.save('/media/tohn/SSD/ModelTrainByImages/R1_Full/models/B5R1_15AB_Full_set1_AddNewDataset.h5')