...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_1/models/B5_R1_5FP_relu_1FC_fold1_1.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_1/mylogsR2_block5_5FP_1FC_1'
def get_run_logdir():
    import time
...
model.save('./models/B5R2b5_5FP_1FC_fold1_1.h5')
