...
os.chdir('/home/jupyter/ModelTrainByImages/R1_1')

root_logdir = '/home/jupyter/ModelTrainByImages/R1_1/mylogsB5_15AB_1FC_relu_5'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_15AB_relu_1FC_fold1_5.h5')
