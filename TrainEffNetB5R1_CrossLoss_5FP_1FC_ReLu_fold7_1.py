## Train model EffNet B5 R1 Fold7 Dataset1 : 5FP Class
...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/Traindf_fold7.csv')
base_dir = '/media/tohn/SSD/Images/Image7'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/Validationdf_fold7.csv')
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_7/mylogsB5_5FP_1FC_relu_1'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_1FC_fold7_1.h5')