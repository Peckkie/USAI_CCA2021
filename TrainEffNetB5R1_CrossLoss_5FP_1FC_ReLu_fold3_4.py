...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/Traindf_fold3_4.csv')
base_dir = '/media/tohn/SSD/Images/Image3'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/Validationdf_fold3_4.csv')
...
os.chdir('/media/tohn/SSD/ModelTrainByImages/R1_3')

root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_3/mylogsB5_5FP_1FC_relu_4'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_1FC_fold3_4.h5')
