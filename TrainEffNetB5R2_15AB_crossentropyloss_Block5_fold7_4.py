...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_7/models/B5_R1_15AB_relu_1FC_fold7_4.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_7/my_logs_block5_15AB_1FC_4'
def get_run_logdir():
    import time
...
model.save('./models/B5R2b5_15AB_1FC_fold7_4.h5')
