## Train model EffNet B5 R1 Fold2 Dataset2 : 5FP Class
...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/Traindf_fold2_2.csv') #แก้ data เปลี่ยนตาม fold
base_dir = '/media/tohn/SSD/Images/Image2' #เปลี่ยนตาม fold
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/Validationdf_fold2_2.csv') #เปลี่ยนตาม fold
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_2/mylogsB5_5FP_1FC_relu_2'  #เปลี่ยน R1_1 เปลี่ยนตาม fold
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_1FC_fold2_2.h5') #เปลี่ยน fold >>> fold1