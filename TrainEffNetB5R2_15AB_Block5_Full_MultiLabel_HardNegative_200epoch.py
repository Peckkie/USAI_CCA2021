...
#Train
dataframe = pd.read_csv('/home/yupaporn/CSV_file/Traindf_Hard_train.csv')
base_dir = '/media/tohn/SSD/Images/Image1'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')
#validation
valframe = pd.read_csv( '/home/yupaporn/CSV_file/Validationdf_fold1_3_NoNormal.csv')
...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R2_Full/models/B5R2_15AB_Full_MultiLabel_fold1_3_NoNormal'
...
model2.save('/media/tohn/SSD/ModelTrainByImages/R2_Full/models/B5R2_15AB_Full_MultiLabel_fold1_3_HardNegative_200epoch')
