## Train model EffNet B5 R1 Fold5 Dataset1 : 5FP Class
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_5/mylogsB5_5FP_1FC_relu_1'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_1FC_fold5_1.h5')