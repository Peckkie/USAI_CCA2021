## Train model EffNet B5 R1 Fold6 Dataset1 : 5FP Class
...
os.environ["CUDA_VISIBLE_DEVICES"]="1" #เปลี่ยนเป็น 1 มี GPU 2 เครื่อง คือ 0 และ 1 
...
#Train
dataframe = pd.read_csv('/home/yupaporn/codes/USAI/Traindf_fold6.csv')
base_dir = '/media/tohn/SSD/Images/Image6'
os.chdir(base_dir)
train_dir = os.path.join(base_dir, 'train')

#validation
valframe = pd.read_csv( '/home/yupaporn/codes/USAI/Validationdf_fold6.csv')
...
os.chdir('/media/tohn/SSD/ModelTrainByImages/R1_6')

root_logdir = '/media/tohn/SSD/ModelTrainByImages/R1_6/mylogsB5_5FP_1FC_relu_1'
def get_run_logdir():
    import time
...
model.save('./models/B5_R1_5FP_relu_1FC_fold6_1.h5')