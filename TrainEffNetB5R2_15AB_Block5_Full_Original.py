...
model_dir = '/media/tohn/SSD/ModelTrainByImages/R1_2/models/B5_R1_15AB_relu_1FC_fold2_3.h5'
...
root_logdir = '/media/tohn/SSD/ModelTrainByImages/R2_Full/my_logs_15AB_Full_Original'
def get_run_logdir():
    import time
...
model.save('./models/B5R2_15AB_Full_Original.h5')
